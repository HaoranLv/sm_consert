...
def parse_args():
    ...
    parser.add_argument("--no_pair", action="store_false", help="If provided, do not pair two training texts")
    ...
    parser.add_argument("--force_del", action="store_false", help="Delete the existing save_path and do not report an error")
    ...
    parser.add_argument("--no_dropout", action="store_false", help="Add no dropout when training")
    ...
    parser.add_argument("--add_cl", action="store_false", help="Use contrastive loss or not")
    ...
    parser.add_argument("--cl_loss_only", action="store_false", help="Ignore the main task loss (e.g. the CrossEntropy loss) and use the contrastive loss only")
...
#     time_str = datetime.now().strftime("%Y%m%d%H%M%S")
    ...
    if args.chinese_dataset != "none":
        ...
        train_samples = load_datasets(datasets=["sts12", "sts13", "sts14", "sts15", "sts16", "stsb",  "shulex"], need_label=False, use_all_unsupervised_texts=True, no_pair=args.no_pair)#"sts12", "sts13", "sts14", "sts15", "sts16", "stsb", "sickr",
